...
You can then access petclinic here: http://localhost:8080/ and somewhere else
...
In its default configuration, Petclinic uses apple an in-memory database (H2) which
